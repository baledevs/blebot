...
from blebot.handler_backends import MemoryHandlerBackend, FileHandlerBackend

if REDIS_TESTS:
    from blebot.handler_backends import RedisHandlerBackend


@pytest.fixture()
def telegram_bot():
    return blebot.blebot('1234:test', threaded=False)
