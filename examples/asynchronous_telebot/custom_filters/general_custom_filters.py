...
class MainFilter(blebot.asyncio_filters.AdvancedCustomFilter):
    key='text'
    @staticmethod
...
class IsAdmin(blebot.asyncio_filters.SimpleCustomFilter):
    key='is_admin'
    @staticmethod
    async def check(message: blebot.types.Message):
