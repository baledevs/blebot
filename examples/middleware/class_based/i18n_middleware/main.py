...
from blebot import types, StateMemoryStorage
from blebot.custom_filters import TextMatchFilter, TextFilter
...
bot = blebot("", state_storage=storage, use_class_middlewares=True)
