from blebot import blebot
from blebot.handler_backends import BaseMiddleware

bot = blebot('TOKEN', use_class_middlewares=True) # set use_class_middlewares to True!
# otherwise, class-based middlewares won't execute.

# You can use this classes for cancelling update or skipping handler:
# from blebot.handler_backends import CancelUpdate, SkipHandler
