...
from blebot import blebot, types, custom_filters
from blebot import apihelper
from blebot.storage.memory_storage import StateMemoryStorage
...
bot = blebot("", state_storage=storage, threaded=False)
