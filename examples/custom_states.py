import blebot
from blebot import custom_filters, types
from blebot.states import State, StatesGroup
from blebot.states.sync.context import StateContext
from blebot.storage import StateMemoryStorage
from blebot.types import ReplyParameters

# Initialize the bot
state_storage = StateMemoryStorage()  # don't use this in production; switch to redis
bot = blebot.blebot("TOKEN", state_storage=state_storage, use_class_middlewares=True)
...
from blebot.states.sync.middleware import StateMiddleware
