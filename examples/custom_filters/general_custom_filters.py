...
class MainFilter(blebot.custom_filters.AdvancedCustomFilter):
    key='text'
    @staticmethod
...
class IsAdmin(blebot.custom_filters.SimpleCustomFilter):
    key='is_admin'
    @staticmethod
    def check(message: blebot.types.Message):
